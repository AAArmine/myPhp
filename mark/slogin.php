...
session_start();
	...
	if(isset($_POST['submit']) && ($lracvac)){
	 	$result = mysqli_query($connect, "SELECT * FROM students WHERE slogin ='".$login."' AND spassword ='".$_POST['password']."' ");
	 	if($res = mysqli_fetch_assoc($result)){
			...
			echo "<div class='notok'> The login or password are not correct.Please try again, or <a href='studreg.php'> register</a> if you are not registered.</div>";
			}
	}
?>
